...
var base = Rebase.createClass('https://toni-rib-catch-of-the-day.firebaseio.com/');
...
var Order = React.createClass({
  renderOrder: function(key) {
    ...
    return (
      <li key={key}>
        <span>
          <CSSTransitionGroup component="span" className="count" transitionName="count" transitionLeaveTimeout={250} transitionEnterTimeout={250}>
